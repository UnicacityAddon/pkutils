...
public class CarOptionsScreen extends OptionsScreen {
    ...
    public void initBody() {
        ...
        addToggleButton(directionalLayoutWidget1, "pkutils.options.car.automation.lock", (options, value) -> options.car().automatedLock(value), options -> options.car().automatedLock(), 150);
        addToggleButton(directionalLayoutWidget1, "pkutils.options.car.automation.start", (options, value) -> options.car().automatedStart(value), options -> options.car().automatedStart(), 150);
